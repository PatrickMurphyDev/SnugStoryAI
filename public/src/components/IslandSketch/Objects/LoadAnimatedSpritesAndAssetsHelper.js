...
const LoadAnimatedSpritesAndAssetsHelper = function LoadAssetsGameMapScene(
  parentAssetsDict,
  that,
  charPos
) {
  ...
  that.playerImageRight = parentAssetsDict["GameMapScene"]["PlayerImageRight"];

  that.otherPlayerImage = parentAssetsDict["GameMapScene"]["OtherPlayerImage"];
...
export default LoadAnimatedSpritesAndAssetsHelper;
